...
public class QuestionOne {
    public static void main(String[] args) {
        ...
        IVerifyString verifyString = new VerifyString();

        String stringToVerify = "bbbbb";

        boolean hasThisString = verifyString.deriveString(stringToVerify, grammar, grammar.getInitialVariable().toString());
